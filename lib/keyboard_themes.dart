      ...
      body: _themes.isEmpty
          ...
          : ListView(
              ...
              children: [
                ...
                ..._themes.map((theme) => Card(
                      clipBehavior: Clip.antiAlias,
                      child: ListTile(
                        leading: CircleAvatar(backgroundColor: _color(theme, 'background')),
                        title: Text(theme['name'] as String),
                        subtitle: Text('${theme['blur']} px blur · ${theme['opacity']} opacity'),
                        trailing: Radio<String>(value: theme['id'] as String, groupValue: _selected,
