...
abstract final class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    "ja": {
      ...
      "autoMatchPhoneOrientationDescription": "スマホ側DextopをAutoへ表示するとき、車載画面の縦横比に合わせて向きを変更します。",
      "autoHiddenDisplay": "実験的：端末側のAutoディスプレイを非表示にする",
      "autoExperimentalFeatures": "実験的な機能",
      "autoHiddenDisplayDescription": "実験的な直接転送方式です。通常は無効のまま使用してください。",
      "autoDisplayModeDescription": "既定では互換性の高い従来方式で、Auto用仮想ディスプレイを端末上にも表示します。",
    },
    "en": {
      "home": "Home",
      "settings": "Settings",
      ...
      "displaySoftwareCursorFallbackSummary": "Use the previous software cursor when enabled",
      "mouseSettingsTitle": "Mouse",
      "mouseSettingsDescription": "Configure virtual mouse input and cursor behavior",
      ...
      "virtualPointerSoftwareDescription": "Use Dextop's original software cursor",
      ...
      "foldableLaptopModeDescription": "Automatically enable laptop mode when a supported fold angle is detected",
      ...
      "keyboardThemesStartFirst": "Start Dextop first to show the real laptop overlay.",
      ...
      "keyboardThemesDescription": "Laptop keyboard themes and custom appearance",
      "autoSettingsTitle": "Auto",
      "autoSettingsDescription": "Auto display and phone-side mirroring options",
      "autoMatchPhoneOrientation": "Match phone mirror orientation to Auto",
      "autoMatchPhoneOrientationDescription": "When Dextop is shown in Auto from the phone-side mirror, adjust its orientation to the head-unit aspect ratio.",
      "autoHiddenDisplay": "Experimental: hide the Auto display on the phone",
      "autoExperimentalFeatures": "Experimental features",
      "autoHiddenDisplayDescription": "Uses experimental direct transfer. Leave this off for normal use.",
      "autoDisplayModeDescription": "The default, compatible mode also shows the Auto virtual display on the phone.",
    },
    "zh": {
      "home": "主页",
      "settings": "设置",
      ...
      "autoMatchPhoneOrientationDescription": "从手机镜像在 Auto 中显示 Dextop 时，根据车机宽高比调整方向。",
      "autoHiddenDisplay": "实验性：在手机上隐藏 Auto 显示",
      "autoExperimentalFeatures": "实验性功能",
      "autoHiddenDisplayDescription": "使用实验性直接传输。正常使用时请保持关闭。",
      "autoDisplayModeDescription": "默认兼容模式也会在手机上显示 Auto 虚拟显示。",
    },
    "ko": {
      "home": "홈",
      "settings": "설정",
      ...
      "autoMatchPhoneOrientationDescription": "휴대전화 미러링으로 Auto에 Dextop을 표시할 때 헤드 유닛 종횡비에 맞춰 방향을 조정합니다.",
      "autoHiddenDisplay": "실험적: 휴대전화에서 Auto 디스플레이 숨기기",
      "autoExperimentalFeatures": "실험적 기능",
      "autoHiddenDisplayDescription": "실험적인 직접 전송을 사용합니다. 일반 사용 시에는 꺼 두세요.",
      "autoDisplayModeDescription": "기본 호환 모드는 Auto 가상 디스플레이를 휴대전화에도 표시합니다.",
    },
    "ru": {
      "home": "Главная",
      "settings": "Настройки",
      ...
      "setupGestureLandscape": "Альбомная ориентация\nСмахните тремя пальцами слева направо",
      "setupGesturePortrait": "Портретная ориентация\nСмахните тремя пальцами сверху вниз",
      ...
      "displaySoftwareCursorFallbackSummary": "При включении используется прежний программный курсор",
      ...
      "virtualTouchpadDescription": "Зарегистрировать как виртуальную сенсорную панель",
      "virtualPointerMouse": "Виртуальная мышь",
      "virtualPointerMouseDescription": "Зарегистрировать как относительную мышь",
      "virtualPointerSoftware": "Программный курсор",
      "virtualPointerSoftwareDescription": "Использовать исходный курсор Dextop",
      ...
      "foldableLaptopModeDescription": "Автоматически включать режим ноутбука при поддерживаемом угле сгиба",
      ...
      "keyboardThemesDeleteBody": "Удалить «{name}»? Это действие нельзя отменить.",
      "keyboardThemesBuiltIn": "Встроенные темы нельзя удалить",
      "keyboardThemesSelectFirst": "Сначала выберите эту тему.",
      "keyboardThemesStartFirst": "Сначала запустите Dextop для показа демонстрации.",
      ...
      "keyboardThemesDescription": "Темы и настройка внешнего вида клавиатуры ноутбука",
      "autoSettingsTitle": "Auto",
      "autoSettingsDescription": "Параметры отображения Auto и зеркалирования телефона",
      "autoMatchPhoneOrientation": "Согласовать ориентацию зеркала телефона с Auto",
      "autoMatchPhoneOrientationDescription": "При показе Dextop в Auto через зеркало телефона менять ориентацию по соотношению сторон головного устройства.",
      "autoHiddenDisplay": "Экспериментально: скрывать дисплей Auto на телефоне",
      "autoExperimentalFeatures": "Экспериментальные функции",
      "autoHiddenDisplayDescription": "Использует экспериментальную прямую передачу. Для обычной работы оставьте выключенным.",
      "autoDisplayModeDescription": "Совместимый режим по умолчанию также показывает виртуальный дисплей Auto на телефоне.",
    },
  };
}
